...
<br>
개발 프레임 워크: 
<img src="https://img.shields.io/badge/SpringBoot-3.2.0-6DB33F?style=flate&logo=SpringBoot&logoColor=6DB33F">
<br>
빌드 : 
...
### 🎫 예매 / 결제 옵션
- 로그인한 유저는 영화 예매를 할 수 있다.
    - 지역, 지점, 영화를 선택할 수 있다.
    - 날짜, 상영 시간을 선택할 수 있다.
    - 해당 상영의 남은 좌석을 확인할 수 있다.
- 유저는 본인의 쿠폰, 포인트를 사용할 수 있다.
- 유저는 자신이 선택한 지점, 영화, 일시, 인원, 좌석 정보를 확인할 수 있다.
---
